      ...
      <div class="controls">
        ...
        <div class="open-menu-wrap" id="open-menu-wrap">
          ...
          <div class="open-menu" id="open-menu" role="menu" hidden>
            <button type="button" class="open-menu__item" id="open-menu-file" role="menuitem" data-i18n="open_file" data-i18n-attr="aria-label">${ICON_FILE_PLUS}<span data-i18n="open_file">Open File</span></button>
